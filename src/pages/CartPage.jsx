...
function CartPage() {
                ...
                {recentOrders.slice(0, 2).map((order) => (
                  <div key={order._id} className="bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
                    <div className="flex justify-between items-center">
                      ...
                      >
                        {loadingReorder === order._id ? 'Loading...' : 'Reorder'}
                      </button>
                    </div>
                  </div>
                ))}
  ...
  return (
    <div className="container mx-auto px-4 py-12 dark:bg-gray-950 min-h-screen">
      <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-8">{'Cart'}</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md dark:shadow-gray-800 p-6 sticky top-24 dark:border dark:border-gray-800">
            ...
            >
              <FaCreditCard /> {!user ? 'Login' + ' to ' + 'Checkout' : 'Checkout'}
            </button>
